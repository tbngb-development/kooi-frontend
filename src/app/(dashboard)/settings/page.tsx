...
type TabKey = "profile" | "workspace" | "team" | "security";
  ...
  return (
    <div className="flex flex-col gap-6 max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        {isPrivileged && (
          <div className="flex items-center gap-1.5 text-base bg-brand-50 border border-brand-100 px-2.5 py-1.5 rounded-md">
