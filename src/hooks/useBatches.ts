...
export function useBatches(campaignId: string) {
  return useQuery({
    queryKey: QUERY_KEYS.BATCHES.list(campaignId),
...
export function useBatch(campaignId: string, batchId: string) {
  return useQuery({
    queryKey: QUERY_KEYS.BATCHES.detail(campaignId, batchId),
...
export function useBatchStats(campaignId: string, batchId: string) {
  return useQuery({
    queryKey: QUERY_KEYS.BATCHES.stats(campaignId, batchId),
...
export function useCreateBatch(campaignId: string) {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      qc.invalidateQueries({ queryKey: QUERY_KEYS.BATCHES.list(campaignId) });
